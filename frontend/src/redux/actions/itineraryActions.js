...
const itineraryAction = {
    ...
    fetchItinerario: () => {
        return async(dispatch,getState)=>{
            const res = await axios.get('https://mytinerary-torrez-fernando.herokuapp.com/api/V1/itineraries')
    ...
    fetchItinerarioPorCity: (id) => {
        return async (dispatch, getState) => {
            try{
                const res = await axios.get(`https://mytinerary-torrez-fernando.herokuapp.com/api/V1/itineraries/${id}`)
    ...
    likeDislike:(itineraryId) => {
        ...
        return async () => {
            try{
                let response = await axios.put(`https://mytinerary-torrez-fernando.herokuapp.com/api/V1/likeDislike/${itineraryId}`,{},
                {
                    headers: {
